...
public class TestUriMatcher extends AndroidTestCase {
    ...
    // Uri: content://com.lex.sunshine.app/weather
    ...
    public void testUriMatcher(){
        ...
        assertEquals("Error: The WEATHER_URI was matched incorrectly",
                testMatcher.match(TEST_WEATHER_DIR), WeatherProvider.WEATHER);
        assertEquals("Error: The WEATHER_WITH_LOCATION URI was matched incorrectly",
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_DIR),
                WeatherProvider.WEATHER_WITH_LOCATION);
        assertEquals("Error: The WEATHER_WITH_LOCATION_AND_DATE URI was mathced incorrectly",
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR),
                WeatherProvider.WEATHER_WITH_LOCATION_AND_DATE);
        assertEquals("Error: The LOCATION URI was matched incorreclly",
