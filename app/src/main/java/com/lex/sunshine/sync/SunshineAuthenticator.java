 ...
 *  Manages "Authentication" to Sunshine's backend service. The SyncAdapter framework requires an
 * authenticator object, so syncing to a service that doesn't need authentication typically means
